 ...
 <div style="height:260px;">
	<table width="100%" class="elementdatatable">    		
		...
		<tbody>
			...
			List<Map<String, String>> list = gjpd.getMyPrjDataForP(userid+"");
			...
			%>
					...
					<td class="reqdetail" width="*" title="我的任务P" >
						<a class="ellipsis" href="<%=map.get("url")%>" target="_blank"><font class="font"><font class="font"><span class="reqname" ><%=map.get("task_name")%></span></font></font></a>
					</td>
					<td ><font class="font"><%=map.get("proj_name")%></font></td>
					<td >
