		...
		<tbody>
			...
			%>
				<tr>
					...
					<td ><a href="javascript:openmeeting(<%=map.get("meetingid")%>)"><font class="font"><span class="reqname" ><%=map.get("name")%></span></font></a></td>
					<td ><font class="font"><%=map.get("address")%></font></td>  
