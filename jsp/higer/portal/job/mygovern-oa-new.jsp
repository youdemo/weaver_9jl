...
overflow-y:hidden;
 ...
 <%
			...
			pageContext.setAttribute("goverlist",list);
			%>
 <div style="height:280px;">
	<table width="100%" class="elementdatatable">    		
		...
		<tbody>
			<c:forEach var="goverlist" items="${goverlist}"> 
				<tr>
					<td><img name="esymbol" src="/page/resource/userfile/image/ecology8/pointer_wev8.png" style="margin-bottom: 4px;"></td>							  
					<td ><a href="javascript:opengovern(${goverlist.governid})"><font class="font"><span class="reqname" >${goverlist.name}</span></font></a></td>
					<td ><a href="javascript:openhrm(${goverlist.creater})" onclick="pointerXY(event);"><font class="font">${goverlist.creatername}</font></a></td>  
					<td ><font class="font" style="float:right;">${goverlist.range}</font></td>  
				</tr>
			</c:forEach>
		 </tbody></table>
	</div>
