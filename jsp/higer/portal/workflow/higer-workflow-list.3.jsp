...
<head>
    ...
    <link href="/higer/portal/workflow/css/index(2).css" rel="stylesheet">
     <link rel="stylesheet" href="/higer/portal/workflow/css/devModuleStyle.css">
    <style>
        #container,body,html {
        height: 100%;
        overflow: hidden
...
<body cz-shortcut-listen="true">
    <div id="container">
		...
		<div class="ant-col-6" style="padding: 0px 10px;">
                        <div>
                            <div class="ant-card ant-card-bordered" style="border-top-color: <%=color[choosetype]%>;">
                                <div class="ant-card-body">
                                    <div style="padding: 5px 0px 25px; text-align: center;">
                                        <div class="wf-card-type-name">
                                            <span style = "width: 40px;height:40px;">
                                                <img src = "/higer/portal/workflow/img/<%=imgsrc[choosetype]%>"/>
                                            </span>
                                            <span style="height: 36px; line-height: 36px;"><%=typename%></span>
                                        </div>
                                    </div>
			...
			%>	
			 						<div class="centerItem">
                                        <div class="fontItem" style="width: 100%;">
