...
<style type="text/css">
 ...
 <BODY >
  <%
		...
		List<Map<String, String>> list = gjpd.getPublicSystemList();
		pageContext.setAttribute("publicSystemList",list);
 ...
 <div class = "application">
		...
		<div class = "applicant_link">
			<ul>
                  <c:forEach var="publicSystemList" items="${publicSystemList}"> 
                    <a href = "${publicSystemList.subsystem_url}" target="_blank">
					<li class="itemcolor">${publicSystemList.subsystem_name}</li>
			    	</a>
                </c:forEach>
			</ul>
		</div>
