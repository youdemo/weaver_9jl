...
public class CreateOrUpdateDocAction2 implements Action{
	...
	public String execute(RequestInfo info) {
		...
		if("".equals(zw)) {
			String docid = "";
			try {
				writeLog("newdocname:"+newdocname+" operaterid:"+operaterid+" doccategory:"+doccategory);
