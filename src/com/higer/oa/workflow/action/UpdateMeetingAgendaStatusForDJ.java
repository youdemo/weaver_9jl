...
import com.higer.oa.workflow.dao.UpdateMeetingAgendaStatusDaoForDj;

import weaver.interfaces.workflow.action.Action;
import weaver.soa.workflow.request.RequestInfo;

public class UpdateMeetingAgendaStatusForDJ implements Action {

	@Override
	public String execute(RequestInfo info) {
		String workflowid = info.getWorkflowid();
		String requestid = info.getRequestid();
		UpdateMeetingAgendaStatusDaoForDj ad = new UpdateMeetingAgendaStatusDaoForDj();
